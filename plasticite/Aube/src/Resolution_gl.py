...
def Local_resolution(Fmd, Fmf, uFd, Interpo, FM, region_num, uG, Fmim):
	...
	Fmd.solve( 'lsearch', 'basic', 'max_iter', 100, 'max_res', 1e-5,'lsolver', 'mumps')
	uF = Fmd.variable('u')
	#Alpha = Fmd.variable('Previous_alpha')
	Fmd.small_strain_elastoplasticity_next_iter(Fmim, 'Prandtl Reuss linear hardening', 0, 'u', 'xi', 'Previous_Ep',
	 							'Previous_alpha', 'lambda','mu', 'sigma_y', 'H_k', 'H_i', '1', 'timestep')
	#Alpha = Fmd.variable('Previous_alpha')
	#Fmd.small_strain_elastoplasticity_next_iter(Fmim, 'Prandtl Reuss', 0, 'u', 'xi', 'Previous_Ep', 'lambda', 'mu',
	# 'sigma_y', '1', 'timestep')
