...
############################################################
# Do not modify below
# Everything necessary should have been provided above
#

# The script creates Global.msh, Aux[i].msh, Fin[i].msh, Complement.msh
# in Global the physical ids for the interface is i
# the physical id for the aux domains is idShift+i
# the physical id for Complement is idShift+npatchs+1
