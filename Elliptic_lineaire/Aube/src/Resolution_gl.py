...
def Global_resolution(solveur, rG_j_2, rG_j_1, rG_j, ci, omega, omega_new, pG, pG_index, rG, Gintdofs, Gmd, Gmf, loc_iter, Dim):
	uG_inter = {}
	if solveur == "Aitken":
		rG_j_2 = rG_j_1
		rG_j_1 = rG_j
	...
	return uG_inter, uG, rG_j, rG_j_1, rG_j_2, omega_new
